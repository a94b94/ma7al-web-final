...
export default function SimilarProducts({
  ...
  return (
    <div className="mt-20">
      <h2 className="text-2xl font-extrabold text-center mb-8 text-indigo-600">🌀 منتجات مشابهة قد تهمك</h2>
      <motion.div
        ...
        {products.map((product: any) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-blue-600 font-bold">{Number(product.price).toLocaleString()} د.ع</p>
            </div>
          </motion.a>
        ))}
      </motion.div>
